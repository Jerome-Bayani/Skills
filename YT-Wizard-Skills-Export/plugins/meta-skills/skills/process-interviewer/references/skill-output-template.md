...
### Be concise
Codex is capable. Don't explain what PDFs are or how libraries work. Only add context Codex doesn't already have. Challenge every paragraph: "Does this justify its token cost?"

### Explain the why, not just the what
Instead of "ALWAYS do X", explain why X matters. Codex responds better to understanding the reasoning than to rigid rules.
