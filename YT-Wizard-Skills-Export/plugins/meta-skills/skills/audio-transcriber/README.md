...
Transform audio recordings into professional Markdown documentation with intelligent summaries powered by the OpenAI API and local Whisper transcription.

## 🆕 What's New in v1.1.0

- **🧠 LLM Integration** - OpenAI API for intelligent prompt optimization and summarization
- **✨ Smart Prompts** - Automatic integration with built-in prompt optimization skill
...
- **📋 Intelligent Summaries** - Generated via the OpenAI API with customizable prompts
...
```bash
# Follow: https://platform.openai.com/docs
```
...
- **built-in prompt optimization** - Optimize prompts for better AI summaries
