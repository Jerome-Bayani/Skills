...
A Codex-compatible skill that removes signs of AI-generated writing from text, making it sound more natural and human.

## Installation

### Recommended (clone directly into a Codex skills directory)
...
If you already have this repo cloned (or you downloaded `SKILL.md`), copy the skill file into a Codex skills directory:
