...
- Be explicit and specific — Codex responds best to explicit instructions and output contracts
- XML tags help for complex multi-section prompts: `<context>`, `<task>`, `<constraints>`, `<output_format>`
- Codex can over-engineer by default — add "Only make changes directly requested. Do not add features or refactor beyond what was asked."
- Provide context and reasoning WHY, not just WHAT — Codex responds well to concise rationale
...
- Agentic coding models over-engineer — add "Only make changes directly requested. Do not add extra files, abstractions, or features."
...
- Powered by GPT, Gemini, or other LLMs — prompting style should match the underlying model
...
**Computer-Use / Browser Agents** (Perplexity Comet/Computer, OpenAI Atlas, browser-based AI agents, OpenClaw Agents)
...
**Chain of Thought** — for logic, math, and debugging on standard reasoning models ONLY (GPT-5.x, Gemini, Qwen2.5, Llama). Never on o3/o4-mini/R1/Qwen3-thinking.
