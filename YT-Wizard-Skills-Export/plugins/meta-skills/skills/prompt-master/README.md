...
A Codex-compatible skill that writes the accurate prompts for any AI tool. Zero tokens or credits wasted. Full context and memory retention. No re-prompting your way to an answer you should have gotten on attempt one.

**Works with:** Codex, ChatGPT, Gemini, o1/o3, MiniMax, Cursor, Windsurf, Bolt, v0, Lovable, Devin, Perplexity, Midjourney, DALL-E, Stable Diffusion, ComfyUI, Sora, Runway, ElevenLabs, Zapier, Make, and other AI tools.

---

## 🚀 Installation

### RECOMMENDED - Codex or ChatGPT

1. Download this repo as a ZIP
2. Use the skill inside your Codex plugin or local Codex skills directory.


### OR Clone directly into a Codex skills directory (Not Suggested)

```bash
mkdir -p ~/.codex/skills
git clone https://github.com/nidhinjs/prompt-master.git ~/.codex/skills/prompt-master
```
...
In Codex, you can invoke the skill naturally:
...
```
I need a prompt for Codex to build a REST API — ask me what you need to know
```
...
I want to ask Codex to build a todo app with React and Supabase
```
...
### User Input
```
Build a Codex prompt for a landing page for a business 
...
```
**🎯 Target:** Codex · **💰 Tokens:** Medium (~380) · **💡 Strategy:** Every vague Notion aesthetic cue translated into exact hex values and pixel specs — Codex cannot guess wrong. Animations defined with exact timing, method, and trigger so there is no interpretation needed.
...
|------|----------|--------------------------|
| **Codex / GPT-5.x** | Reasoning LLM | Output contract, structure, and completion criteria |
...
| **Codex** | Agentic AI | Stop conditions, file scope, checkpoint output |
| **Cursor / Windsurf** | IDE AI | File path, function name, do-not-touch list, sequential prompt guidance |
| **Cline** | Agentic IDE | File scope, approval gates, stop conditions, task breakdown |
...
| **ReAct + Stop Conditions** | Codex, Devin, AutoGPT — any autonomous agent |
...
| **XML Structural Tags** | Wraps sections in XML for tools that benefit from explicit structure |
...
- **1.4.0** — Added reference image editing detection, ComfyUI support, Prompt Decompiler mode. Fixed trigger description to invoke correctly in Codex. 3 new templates added to references folder
