...
**Important:** Only use CoT for standard reasoning models (GPT-4o, Gemini). Do NOT add CoT instructions to o1, o3, or extended thinking modes — they reason internally and CoT instructions degrade their output.
...
- Use XML tags to wrap examples — explicit structure helps some models parse examples reliably.
